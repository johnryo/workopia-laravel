<x-layout>
  ...
  <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
    ...
    <form method="POST" action="{{route('jobs.store')}}" enctype="multipart/form-data">
      ...
      <x-inputs.text id="salary" type="number" name="salary" label="Salary" placeholder="90,000" />
      ...
      <x-inputs.text-area id="benefits" name="benefits" label="Benefits" placeholder="Health insurance, 401(k), paid time off" />
      ...
      <x-inputs.text id="zipcode" name="zipcode" label="Zip Code" placeholder="02214" />
      ...
      <x-inputs.text id="contact_email" type="email" name="contact_email" label="Contact Email" placeholder="Enter Contact Email" />
